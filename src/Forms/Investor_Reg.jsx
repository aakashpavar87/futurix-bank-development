...
const Investor_Reg = () => {
        ...
        <div className="grid grid-cols-1 gap-4">
          ...
          <div className="relative">
            <input
              ...
              id="lastName"
              name="lastName"
              className={`border rounded-md px-3 py-2 w-full  shadow-sm shadow-white focus:border-blue-500 focus:ring-blue-500 ${focusedInput === "lastName" ? 'animate-pulse' : ''}`}
  ...
  <input
    ...
    className={`border rounded-md px-3 py-2 w-full shadow-sm shadow-white focus:border-blue-500 focus:ring-blue-500 ${focusedInput === "confirmPassword" ? 'animate-pulse' : ''}focus:border-blue-500 focus:ring-blue-500 ${focusedInput === "confirmPassword" ? 'animate-pulse' : ''}`}
