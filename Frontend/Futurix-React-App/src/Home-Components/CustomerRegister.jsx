...
import { createUser, getUserByEmail } from "../apis/UserApi";
      ...
      try {
        ...
        setTimeout(async () => {
          ...
          navigate("/verify-account", {
            state: { level: "register", email: Email },
          });
        }, 1500);
      } catch (err) {
  ...
  return (
    <>
      ...
      >
        <img
          src={registerimg}
          className="mr-2 w-2/4 hidden md:block place-self-flex shadow-lg shadow-white rounded-md backdrop-blur-md"
        />
        <form
          ...
          <div className="grid grid-cols-1 gap-4">
            ...
            <div className="relative">
              <input
                ...
                name="phone"
                className={`border rounded-md px-3 py-2 w-full  shadow-sm shadow-whitefocus:border-blue-500 focus:ring-blue-500 ${
                  focusedInput === "phone" ? "animate-pulse" : ""
                }`}
                {...register("phone", {
                  required: {
                    value: true,
            ...
            <div className="relative">
              <input
                ...
                name="occupation"
                className={`border rounded-md px-3 py-2 w-full shadow-sm shadow-whitefocus:border-blue-500 focus:ring-blue-500 ${
                  focusedInput === "occupation" ? "animate-pulse" : ""
                }`}
                {...register("occupation", {
                  required: {
                    value: true,
